...
<div class="ally-group" data-ads='${id}' style="display:inline-block;width:728px;height:90px;position:relative;">
  ...
  <div class="ally-info" style="display:none; position:absolute;left:652px;top:5px;justify-content:center;align-items:center;gap:4px;">
    ...
    <button class="ally-close" data-ads='${id}' style="display:flex;justify-content:center;align-items:center;min-width:12px;min-height:12px;border:1px solid #1C191729;background:#FFFFFF33;border-radius:6px;">
...
<div class="ally-group" data-ads='${id}' style="display:inline-block;width:270px;height:90px;position:relative;">
  ...
  <div class="ally-info" style="display:none; position:absolute;left:180px;top:5px;justify-content:center;align-items:center;gap:4px;">
    ...
    <button class="ally-close" data-ads='${id}' style="display:flex;justify-content:center;align-items:center;min-width:12px;max-width:12px;min-height:12px;border:1px solid #1C191729;background:#FFFFFF33;border-radius:6px;">
      <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.78226 1.07516C1.587 0.879895 1.27042 0.879895 1.07516 1.07516C0.879895 1.27042 0.879895 1.587 1.07516 1.78226L3.29303 4.00014L1.07516 6.21801C0.879896 6.41328 0.879896 6.72986 1.07516 6.92512C1.27042 7.12038 1.587 7.12038 1.78226 6.92512L4.00014 4.70725L6.21801 6.92512C6.41328 7.12038 6.72986 7.12038 6.92512 6.92512C7.12038 6.72986 7.12038 6.41328 6.92512 6.21801L4.70725 4.00014L6.92512 1.78226C7.12038 1.587 7.12038 1.27042 6.92512 1.07516C6.72986 0.879895 6.41328 0.879895 6.21801 1.07516L4.00014 3.29303L1.78226 1.07516Z" fill="#1C1917" fill-opacity="0.6"/>
      </svg>
    </button>
